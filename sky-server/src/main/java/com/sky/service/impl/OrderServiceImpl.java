...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderPaymentVO payment(OrdersPaymentDTO ordersPaymentDTO) throws Exception {
        ...
        //调用微信支付接口，生成预支付交易单
        //TODO 由于是个人身份微信支付实现不了  改为点击以后即可支付
...
//        );
    ...
    public void paySuccess(String outTradeNo) {
        ...
        //提供websocket想客户端浏览器推送type orderId content
...
//                    new BigDecimal(0.01));//原订单金额
            log.info("退款成功：商户订单号："+ordersDB.getNumber()+"--商户退款单号:"+ordersDB.getNumber()
            +"--退款金额"+new BigDecimal(0.01)+"单位 元--原订单金额:"+new BigDecimal(0.01));
            //支付状态修改为 退款
...
//                    new BigDecimal(0.01),
//                    new BigDecimal(0.01));
            log.info("申请退款：{}"+ordersDB.getNumber()+"--退款金额："+new BigDecimal(0.01));
        }
